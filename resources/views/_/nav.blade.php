<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">SMS GATEWAY</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <div data-i18n="Layouts">Enregistrements</div>
            </a>

            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('typesms.all') }}" class="menu-link">
                        <div data-i18n="Without menu">Type SMS</div>
                    </a>
                </li>
                <li class="menu-item">
