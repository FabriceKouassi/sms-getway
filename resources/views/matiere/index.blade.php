...
<div class="layout-page">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <a class="btn btn-primary" href="{{ route('matiere.saveForm') }}"><span class="icon-style">+</span> Ajouter {{ $title }}</a>
            <div class="card mt-3">
                <main class="cd__main">
                            ...
                            @foreach ($matiere as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="{{ route('matiere.updateForm', [$item->id]) }}"><i class="bx bx-edit-alt me-1"></i> Modifier</a>
                                        <a class="btn btn-warning" href="{{ route('matiere.delete', [$item->id]) }}"><i class="bx bx-trash me-1"></i> Suprimer</a>
                                    </td>
                                </tr>
                            @endforeach
                        <tbody>
        ...
        <div class="mt-3">
            ...
            <div class="modal fade" id="saveModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form class="modal-content" method="POST" action="{{ route('matiere.save') }}" id="saveForm">
                        @csrf
